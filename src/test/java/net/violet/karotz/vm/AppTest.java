...

{
    ...
    public void httpGet() throws ScriptException {
        Context.getCurrentContext().evaluateString(engine, "print(http.get('http://www.google.fr'));", "httpGet.js", 0, null);
    }
...
//        engine.eval("if( mavar['content'] == undefined ) { throw 'Content undefined'; }");
//    }
//    
//    @Test
